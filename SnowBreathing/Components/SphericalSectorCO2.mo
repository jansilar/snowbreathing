...
model SphericalSectorCO2
  parameter Real theta(units = "rad") = pi "angle from cone axle to the wall";
  parameter Real facA(units = "1/m2") = 2*pi(1-cos(theta)) "facA*r^2 = cone outside surface area";
