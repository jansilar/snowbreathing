...
model c004_11m2000_snow
  ...
  Components.ConeCompGrad coneCompGrad1(D_CO2 = 4.48799322137e-4, D_O2 = 4.48799322137e-4, caseID = "c004-11m2000", gamma = 30, solubilityModel = 2)  annotation(
...
equation
  ...
  annotation(
    experiment(StartTime = 0, StopTime = 580, Tolerance = 1e-06, Interval = 0.1));
