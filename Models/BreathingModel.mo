  ...
  model LungMechanics
    ...
    Physiolibrary.Hydraulic.Components.Resistor R_bA(Resistance(displayUnit=
      ...
      annotation (Placement(visible=true, transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=0)));
    SemestralProjectDoloi_2017.LungMechanics.Components.Airway C_tr(
      ...
      init_vol(displayUnit="ml") = 1.85706e-05) annotation (Placement(visible=
          ...
          extent={{-10,-10},{10,10}},
          rotation=-90)));
    SemestralProjectDoloi_2017.LungMechanics.Components.Airway C_b(
    ...
    SemestralProjectDoloi_2017.LungMechanics.Subsystems.Pmus pulmonaryMuscles
      annotation (Placement(visible=true, transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=-90)));
    SemestralProjectDoloi_2017.LungMechanics.Components.Airway C_A(
    ...
    Physiolibrary.Hydraulic.Sensors.FlowMeasure totalAirFlow annotation (
        Placement(visible=true, transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=0)));
    SemestralProjectDoloi_2017.LungMechanics.Components.Airway C_l(
...
<p><span style=\" font-family:'Courier New'; font-size:12pt; color:#008b00;\">Compute partial pressure of gas from its fraction in medium, P_atm and P_ws. </span></p></body></html>"));
  ...
  model CirculationGas
    Physiolibrary.Chemical.Components.Substance arteries
    ...
    parameter Real m3PerMole=24e-3 "molar volume of the gas";
    ...
    Physiolibrary.Chemical.Sources.UnlimitedSolutionStorage atmosphereSource
      annotation (Placement(transformation(
          extent={{-10,-10},{10,10}},
          rotation=0,
          origin={-110,74})));
  ...
  equation
    ...
    connect(concentrationMeasure3.concentration, alvFrac.u)
      annotation (Line(points={{78,66},{85.4,66},{85.4,35}}, color={0,0,127}));
    connect(subs_alveoli.q_out, concentrationMeasure3.q_in) annotation (Line(
        points={{36,74},{78,74}},
        color={107,45,134},
        thickness=1));
    connect(alvFrac.y, CO2_alveolarGasExchange.Fa) annotation (Line(points={{
            69.3,35},{65.65,35},{65.65,36},{60,36}}, color={0,0,127}));
    connect(tracheaStream.q_in, atmosphereSource.q_out) annotation (Line(
        points={{-84,74},{-100,74}},
        color={107,45,134},
        thickness=1));
    connect(add.y, concentrationDiff.concentration)
      annotation (Line(points={{50.5,-35},{60,-35}}, color={0,0,127}));
    connect(concentrationDiff.q_out, gasExhaleFlow.q_in) annotation (Line(
        points={{70,-35},{70,-34},{78,-34}},
        color={107,45,134},
        thickness=1));
    connect(gasExhaleFlow.q_out, concentrationMeasure3.q_in) annotation (Line(
        points={{98,-34},{108,-34},{108,74},{78,74}},
        color={107,45,134},
        thickness=1));
